...
class Model_auth extends CI_Model
{
	...
	/* 
		   This function checks if the email exists in the database for clients
	   */
	...
	/* 
		   This function checks if the email and password matches with the database for clients
	   */
