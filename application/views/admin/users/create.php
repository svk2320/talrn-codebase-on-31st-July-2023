      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card">
            ...
            <form role="form" action="<?php base_url('admin/users/create') ?>" method="post">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <a href="<?php echo base_url('admin/users/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
