    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6" style="display:flex">
          <h1 class="m-0 text-dark">Approve Profiles</h1>
          <a href="<?php echo base_url('admin/approval/approved') ?>" class="btn btn-primary" style="margin-left:30px;">Approved list</a>
        </div><!-- /.col -->
        <div class="col-sm-6">
                  ...
                  <?php foreach ($list as $k => $v): ?>
                    <tr>
                      ...
                      <td class="text-nowrap">
                        ...
                        <a href="<?php echo base_url("admin/approval/approve/") . $v['unique_id'] ?>"
                          class="btn btn-default"><i class="fa fa-thumbs-up"></i></a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                <?php } ?>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    history.pushState({}, null, '<?= base_url('admin/approval') ?>');
