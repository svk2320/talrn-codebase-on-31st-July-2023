...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url('admin/auth/login'); ?>/"><b>Talrn</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="<?php echo base_url('admin/auth/login') ?>" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <div style="width:100%;font-size:14px" class="mt-2"><a href="<?=base_url('forgot-password')?>">Forgot password?</a></div>
          </div>
          <div class="row">
            <div class="col-8">
        ...
        <p class="mb-0 text-center">Don't have an account?
          <a href="<?= base_url('join') ?>" class="text-center"> Join Talrn</a>
        </p>
      </div>
      <!-- /.login-card-body -->
    </div>
