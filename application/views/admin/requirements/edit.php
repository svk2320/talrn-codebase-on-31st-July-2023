...
<link media="all" rel="stylesheet" href="<?php echo base_url() . $this->config->item('css') . 'admin-requirement-edit.css' ?>">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/requirements/update/').$requirements[0]['id']; ?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="experience" min="0" name="experience" value="<?= $requirements[0]['experience']?>">
                                </div>
