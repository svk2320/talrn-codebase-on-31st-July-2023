        ...
        <div class="row mb-2">
          <div class="col-sm-6" style="display:flex;">
            ...
            <?php if(in_array('createGroup', $user_permission)): ?>
                <a href="<?php echo base_url('admin/groups/create') ?>" class="btn btn-primary" style="margin-left:30px">Add Group</a>
            <?php endif; ?>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <?php foreach ($groups_data as $k => $v): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url('admin/groups/edit/'.$v['id']) ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                          <?php if(in_array('deleteGroup', $user_permission)): ?>
                          <a href="<?php echo base_url('admin/groups/delete/'.$this->atri->en($v['id'])) ?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                          <?php endif; ?>
                        </td>
                        <?php endif; ?>
                      </tr>
