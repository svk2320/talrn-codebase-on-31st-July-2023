...
<link media="all" rel="stylesheet" href="<?php echo base_url() . $this->config->item('css') . 'admin-vendor-index.css' ?>">
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Upload Profile</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><div class="col-lg-3">
              <a href="<?= base_url('admin') ?>">Home </a>
            </li>
            <li class="breadcrumb-item active">Upload profile</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
  ...
  <section class="content">
    ...
    <?php if($this->model_stores->get_draft_profile_count_by_vendor_id($_SESSION['id'])){ ?>
            <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="card">
          ...
          echo form_open('admin/vendor/editdraftformdata?step=tab&id='.$profile[0]['id'], $attributes);
          ?>
          <div class="tab">
            <div class="container">
              <div class="row">
          ...
          <div class="tab">
            <div class="container">
              <div class="row">
                <div class="col-lg-1">&nbsp;</div>
                <div class="col-lg-10 py-4">
                  <div class="h3 text-center fw-bold"> Professional experience </div>
                  <div class="row mt-4">
                    <div class="col-lg-8">
                  ...
                  <div class="add_skill_wrapper mt-3">
                        <div class="row skill_list">
                          <div class="col-lg-5">
                            ...
                            <div class="loading-circle"></div></div>
           ...
           <div class="tab">
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-lg-10 py-4">
                            <div class="h3 text-center fw-bold"> Project details  </div>
          ...
          <div class="tab">
            <div class="container">
              <div class="row">
                <div class="col-lg-1">&nbsp;</div>
                <div class="col-lg-10 py-4">
                  <div class="h3 text-center fw-bold"> Employment History </div>
                  <div class="exp_wrapper" style="margin-top:30px;">
                    <div class="row mt-6">
                      ...
                      <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">Job Title <div class="position-relative"><input autocomplete="off" name="exp[0][]" type="text"
                            placeholder="Title name" class="form-control titleAutoComplete"  value="<?=$profile_exp[0]['title'] ?>"/>
                           <div class="loading-circle"></div>
                        </div>
                        </div>
                      </div>
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-start">
                          <div class="options col-lg-6" style="margin-bottom: 25px;">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <?php if (isset($profile) && is_array($profile) && isset($profile[0]['userPhoto'])): ?>
                                ...
                                <?php else: ?>
                                    <img class="cropped" src="<?= base_url('assets/img/noimage.jpg') ?>" alt="" onerror="this.onerror=null; this.src='<?=base_url('assets/img/noimage.jpg')?>'">
                                <?php endif; ?>
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" name="imageFilePath" class="form-control" id="imageFilePath" value="uploads/" style="display: none">
                          </div>
                        </div>
    ...
    <?php } elseif ($_SESSION['username'] == 'Individual' && $this->model_stores->get_profile_count_by_store_id($_SESSION['store_id']) > 0) { ?>
      <div class="card card-outline card-primary col-md-8">
        <div class="card-header">
          <h3 class="card-title">Multiple profiles not allowed</h3>
        </div>
        <div class="card-body">
          <p>An individual can only upload one profile. If you want to upload more than one profile, you will need to
            upgrade to organisation.</p>
        </div>
    ...
    <?php } else { ?>
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="card">
            <!--<div class="card-header">-->
            <!--  <h3 class="card-title">Upload profile</h3>-->
            <!--</div>-->
            <!-- PLEASE UPDATE HRER -->
            <div class="stepper-wrapper">
              <div class="stepper-item">
            ...
            <div class="tab">
              <div class="container">
                <div class="row">
                  <div class="col-lg-1">&nbsp;</div>
                  <div class="col-lg-10 py-4">
                    <div class="h3 text-center fw-bold"> Profile </div>
                    <!--<div class="h3 text-center fw-bold"> Upload profile information here </div>-->
                    <!-- <div class="text-center">
                    <p>Talrn matches resources with top companies globally.</p>
                  </div> -->
                    <div class="row mt-4">
                      <div class="col-lg-7">
                        <label class='fw-bold'>First name *</label>
                        <input type="text" class="form-control py-3 mt-2" placeholder='First name' name='first_name'
                          value='<?= $firstname ?>' id='first_name' />
                        <div class="req text-danger" id='first_name_error'>This field is required</div>

                        <label class='fw-bold mt-4'>Last name *</label>
                        <input type="text" class="form-control py-3 mt-2" placeholder='Last name' name='last_name'
                          value='<?= $lastname ?>' id='last_name' />
                        <div class="req text-danger" id='last_name_error'>This field is required</div>
                        ...
                        <select class="form-control select-box" name="country" id="country">
                          ...
                          foreach ($countries as $country) {
                            ...
                            $country_code = $country['code'];
                            $country_name = $country['name'];
                            echo '<option value="' . $country_code . ':' . $country_name . '" >' . $country_name . '</option>';
                          }
                          ?>
                        </select>
                        </div>
                        ...
                        <label class='fw-bold mt-4'>City *</label>
                        <input type="text" class="form-control py-3 mt-2" placeholder='City' name='city' id='city'
                          value='<?= $city ?>' />
                        <div class="req text-danger" id='city_error'>This field is required</div>

                        <label class='fw-bold mt-4'>Citizenship *</label>
                        <input type="text" class="form-control py-3 mt-2" placeholder='e.g. Andorra' name='citizenship'
                          id='citizenship' />
                        <div class="req text-danger" id='citizenship_error'>This field is required</div>

                        <label class='fw-bold mt-4'>English proficiency *</label>
                        <div class='mt-2'>
                          <input class='english-radio' type="radio" name="english" id="native" value="native" />
                          <label class='english-label' htmlFor="" for="native">Native/Fluent</label>

                          <input class='english-radio' type="radio" name="english" id="advanced" value="advanced" />
                          <label class='english-label' for="advanced">Advanced</label>

                          <input class='english-radio' type="radio" name="english" id="intermediate"
                            value="intermediate" />
                          <label class='english-label' for="intermediate">Intermediate</label>

                          <input class='english-radio' type="radio" id="basic" name="english" value="basic" />
                          <label class='english-label' for="basic">Basic</label>
                          <div class="req text-danger" id="proficiency_error">This field is required</div>
                        </div>
                  ...
                  <div class="col-lg-10 py-4">
                    ...
                    <div class="row mt-4">
                      <div class="col-lg-8">
                        <label class='fw-bold'>How many years of professional experience do you have in your field
                          overall? *</label>
                        <input type="number" min="0" step="1" onfocus="this.previousValue = this.value"
                          onkeydown="this.previousValue = this.value"
                          oninput="validity.valid || (value = this.previousValue)" class="form-control"
                          placeholder="Enter your years of experience" name="experience" id="years_of_experience">
                        <div class="req text-danger" id="years_of_experience_error">This field is required</div>

                        <label class='fw-bold mt-2'>Primary job title *</label>
                        <div class="position-relative">
                        <input type="text" class="form-control titleAutoComplete"  name="primary_title" autocomplete="off"
                          placeholder="Enter your primary job title" id="primary_job_title">
                          <div class="loading-circle"></div>
                        </div>
                        <div class="req text-danger" id="primary_job_title_error">This field is required</div>
                      ...
                      <label for="fw-bold mt-2">Work Location:</label>
                      <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="remote_location[]" id="remote" value="remote">
                          <label class="custom-control-label" style="line-height: 22px;" for="remote">Remote</label>
                      </div>
                      <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="remote_location[]" id="onsite" value="onsite">
                          <label class="custom-control-label" style="line-height: 22px;" for="onsite">Onsite</label>
                      </div>

                      <div id="remote-options" style="display:none;margin-left:20px">
                          <div class="custom-control custom-checkbox">
                              <input class="custom-control-input" type="checkbox" name="remote_location[]" id="same-city" value="same-city">
                              <label class="custom-control-label" style="line-height: 22px;" for="same-city">Current City </label>
                          </div>
                          <div class="custom-control custom-checkbox">
                              <input class="custom-control-input" type="checkbox" name="remote_location[]" id="same-country" value="same-country">
                              <label class="custom-control-label" style="line-height: 22px;" for="same-country">Anywhere in Current Country </label>
                          </div>
                          <div class="custom-control custom-checkbox">
                              <input class="custom-control-input" type="checkbox" name="remote_location[]" id="work-permit" value="work-permit">
                              <label class="custom-control-label" style="line-height: 22px;" for="work-permit">Anywhere with Work Permit</label>
                          </div>
                      </div>
                      <?php if($user_data['registered_as'] == 2){ ?>
                      <label class="fw-bold mt-4">Are you actively looking for remote jobs? *</label>
                      <div class="card availibility-card" style="cursor: pointer;" onclick="selectCard('ready_to_interview')">
                        <div class="card-body">
                          <input type="radio" class="job-status-radio" name="job_status" id="ready_to_interview" value="Ready to Interview" />
                          <label for="ready_to_interview">Ready to Interview</label>
                          <p>I am actively looking for a new remote job. Mark me available to interview for the next 30 days. </p>
                        </div>
                      </div>
                      <div class="card availibility-card" style="cursor: pointer;" onclick="selectCard('open_to_offers')">
                        <div class="card-body">
                          <input type="radio" class="job-status-radio" name="job_status" id="open_to_offers" value="Open to Offers"/>
                          <label for="open_to_offers">Open to Offers</label>
                          <p>I am not actively looking for a new remote jobs, but I am available to hear about new job opportunities for the next 30 days. </p>
                        </div>
                      </div>
                      <div class="card availibility-card" style="cursor: pointer;" onclick="selectCard('unavailable_for_jobs')">
                        <div class="card-body">
                          <input type="radio" class="job-status-radio" name="job_status" id="unavailable_for_jobs" value="Unavailable for jobs" />
                          <label for="unavailable_for_jobs">Unavailable for jobs</label>
                          <p>I am not looking for a new remote job at the moment.</p>
                        </div>
                      </div>
                      <?php }else{ ?>
                        ...
                        <?php } ?>
                        <div class="req text-danger" id="job_status_error">This field is required</div>
                        <label class='fw-bold mt-4'>Which type of comittment do you prefer? *</label>
                        <div class="py-3">
                          <div>
                            <input type="radio" name="comittment" id="full" value="Full-time">
                            <label for="full" class="px-2">Full-time (40 hours/week) <span
                                class="text-muted">(Recommended)</span></label>
                          </div>
                          <div>
                            <input type="radio" name="comittment" id="part" value="Part-time">
                            <label for="part" class="px-2">Part-time (20 hours/week)</label>
                          </div>
                          <div>
                            <input type="radio" name="comittment" id="hour" value="Hourly">
                            <label for="hour" class="px-2">Hourly (upto 10 hours/week)</label>
                          </div>
                          <div class="req text-danger" id="comittment_error">This field is required</div>
                        </div>
                      ...
                      <div class="py-2" >
                        <div>
                        <input type="radio" name="notice-period" id="Immediately" value="0">
                        <label for="Immediately" class="px-2">Immediately</label>
                        </div>
                        <div>
                        <input type="radio" name="notice-period" id="notice-period-custom" value="1"  >
                        <label for="notice-period-custom" class="px-2">In <input type="number" style="width: 40px;height: 25px;"  class="d-inline-block" id="notice-period-input" name="notice-period-input" value="1" /> week after I get the offer </label>
                        </div>
                        <div class="req text-danger" id="notice-period_error">This field is required</div>
                      </div>
                      <?php }else{ ?>
                        ...
                        <?php } ?>
                        <label class='fw-bold mt-4'>LinkedIn</label>
                        <input type="text" name="linkedin" class="form-control py-3 mt-2"
                          placeholder='Linkedin profile link' />
                        <label class='fw-bold mt-4'>Github</label>
                        <input type="text" name="github" class="form-control py-3 mt-2"
                    ...
                    <div class="add_skill_wrapper mt-3">
                      <div class="row skill_list">
                        <div class="col-lg-5">
                          <span>Skill name *</span>
                          <div class="position-relative">
                          <input type="text" class="form-control skillAutoComplete"  name="skill_details[0][]"
                            placeholder="Skill name" autocomplete="off" id="skill_name0">
                          <div class="loading-circle"></div>
                          </div>
                          <div class="req text-danger" id="skill_name0_error">This field is required</div>
                        </div>
                        ...
                        <div class="col-lg-1">
                          <button type='button' class="btn btn-primary mt-4 add_skill">+</button>
                        </div>
                      ...
                      <div class="row skill_list">
                        <div class="col-lg-5 mt-2">
                          <div class="position-relative">
                          <input type="text" class="form-control skillAutoComplete"  name="skill_details[1][]"
                            placeholder="Skill name" autocomplete="off" id="skill_name1">
                          <div class="loading-circle"></div>
                          </div>
                          <div class="req text-danger" id="skill_name1_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[1][]" placeholder="Years"
                            id="skill_year1">
                          <div class="req text-danger" id="skill_year1_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[1][]" placeholder="Months"
                            id="skill_month1">
                          <div class="req text-danger" id="skill_month1_error">This field is required</div>
                        </div>
                      ...
                      <div class="row skill_list">
                        <div class="col-lg-5 mt-2">
                          <div class="position-relative">
                          <input type="text" class="form-control skillAutoComplete"  name="skill_details[2][]"
                            placeholder="Skill name" autocomplete="off" id="skill_name2">
                          <div class="loading-circle"></div>
                          </div>
                          <div class="req text-danger" id="skill_name2_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[2][]" placeholder="Years"
                            id="skill_year2">
                          <div class="req text-danger" id="skill_year2_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[2][]" placeholder="Months"
                            id="skill_month2">
                          <div class="req text-danger" id="skill_month2_error">This field is required</div>
                        </div>
                      ...
                      <div class="row skill_list">
                        <div class="col-lg-5 mt-2">
                          <div class="position-relative">
                          <input type="text" class="form-control skillAutoComplete"  name="skill_details[3][]"
                            placeholder="Skill name" autocomplete="off" id="skill_name3">
                          <div class="loading-circle"></div>
                          </div>
                          <div class="req text-danger" id="skill_name3_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[3][]" placeholder="Years"
                            id="skill_year3">
                          <div class="req text-danger" id="skill_year3_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[3][]" placeholder="Months"
                            id="skill_month3">
                          <div class="req text-danger" id="skill_month3_error">This field is required</div>
                        </div>
                      ...
                      <div class="row skill_list">
                        <div class="col-lg-5 mt-2">
                          <div class="position-relative">
                          <input type="text" class="form-control skillAutoComplete"  name="skill_details[4][]"
                            placeholder="Skill name" autocomplete="off" id="skill_name4">
                            <div class="loading-circle"></div>
                          </div>
                          <div class="req text-danger" id="skill_name4_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[4][]" placeholder="Years"
                            id="skill_year4">
                          <div class="req text-danger" id="skill_year4_error">This field is required</div>
                        </div>
                        <div class="col-lg-2 mt-2">
                          <input type="number" class="form-control" name="skill_details[4][]" placeholder="Months"
                            id="skill_month4">
                          <div class="req text-danger" id="skill_month4_error">This field is required</div>
                        </div>
              ...
              <div class="container">
                <div class="row ">
                  ...
                  <div class="col-lg-10 py-4">
                    ...
                    <div class="req text-danger" id="projects_error">This field is required</div>
                    <div class="project_wrapper" style="margin-top:30px;">
                    <button id="addmore" class="btn btn-primary add_input" type="button">Add more projects</button>

                      <div class="project required_inp">
                        <div class="row more_projects">
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group"> Project Title * <input autocomplete="off" name="project_details[0][]"
                                type="text" placeholder="Project title" class="form-control" id="project_title0" />
                              <div class="req text-danger" id="project_title0_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">Technologies used *<input autocomplete="off" name="project_details[0][]"
                                type="text" placeholder="Technologies used" class="form-control" id="project_tech0" />
                              <div class="req text-danger" id="project_tech0_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group"> Start date <input autocomplete="off" name="project_details[0][]"
                                placeholder="Start date" class="form-control monthYearPicker" id="start_pro0" />

                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group"> End date <input autocomplete="off" name="project_details[0][]"
                                placeholder="End date" id="end_pro0" class="form-control monthYearPicker" />

                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Project Description  *<textarea class="form-control"
                                placeholder="Project Description" style="height: 70px" name="project_details[0][]"
                                id="project_description0"></textarea>
                              <div class="req text-danger" id="project_description0_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Your Responsibilities * <textarea class="form-control"
                                placeholder="Your Responsibilities" style="height: 70px" name="project_details[0][]"
                                id="project_resp0"></textarea>
                              <div class="req text-danger" id="project_resp0_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Project URL(Website/Play Store/App Store)
                              <input autocomplete="off" name="project_details[0][]" id="project_url0" type="text"
                                placeholder="If project is not live, please leave empty" class="form-control" />
                              <div class="req text-danger" id="project_url0_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Industry *
                              <div class="position-relative">
                                  <input name="project_details[0][]" type="text" placeholder="Industry type"
                                    class="form-control basicAutoComplete"  autocomplete="off" id="project_industry0" />
                                  <div class="loading-circle"></div>
                              </div>
                              <div class="req text-danger" id="project_industry0_error">This field is required</div>
                            </div>
                          </div>
                        </div>
                        <input type="button" class="inputRemove btn btn-danger" id="0" value="Remove project">
                      </div>
                      <div class="project required_inp">
                        <div class="row more_projects">
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">Project Title  *<input autocomplete="off" name="project_details[1][]"
                                type="text" placeholder="Project title" class="form-control" id="project_title1">
                              <div class="req text-danger" id="project_title1_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">Technologies used * <input autocomplete="off"
                                name="project_details[1][]" type="text" placeholder="Technologies used"
                                class="form-control" id="project_tech1">
                              <div class="req text-danger" id="project_tech1_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">Start date <input autocomplete="off" id="start_pro"
                                name="project_details[1][]" placeholder="Start date" class="form-control monthYearPicker">
                            </div>
                          </div>
                          <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">End date <input autocomplete="off" id="end_pro"
                                name="project_details[1][]" placeholder="End date" class="form-control monthYearPicker">
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Project Description *<textarea class="form-control"
                                placeholder="Project Description" style="height:70px" name="project_details[1][]"
                                id="project_description1"></textarea>
                              <div class="req text-danger" id="project_description1_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Your Responsibilities *<textarea class="form-control"
                                placeholder="Your Responsibilities" style="height:70px" name="project_details[1][]"
                                id="project_resp1"></textarea>
                              <div class="req text-danger" id="project_resp1_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Project URL <input autocomplete="off" name="project_details[1][]"
                                type="text" placeholder="If project is not live, please leave empty" class="form-control"
                                id="project_url1">
                              <div class="req text-danger" id="project_url1_error">This field is required</div>
                            </div>
                          </div>
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">Industry * <div class="position-relative"><input name="project_details[1][]" type="text"
                                placeholder="Industry type" class="form-control basicAutoComplete"  autocomplete="off"
                                id="project_industry1">
                                <div class="loading-circle"></div>
                             </div>
                              <div class="req text-danger" id="project_industry1_error">This field is required</div>
                            </div>
                          </div>
                        </div>
                        <input type="button" class="inputRemove btn btn-danger" id="1" value="Remove project">
                      </div>
                  ...
                  <div class="col-lg-10 py-4">
                    ...
                    <div class="exp_wrapper" style="margin-top:30px;">
                      <div class="row mt-6">
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group">Company name <input autocomplete="off" name="exp[0][]" type="text"
                              id="emp_company_name0" placeholder="Company name" class="form-control" />
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group">Job Title <div class="position-relative"> <input autocomplete="off" name="exp[0][]" type="text"
                              id="emp_title0" placeholder="Title name" class="form-control titleAutoComplete"  />
                          </div>
                          <div class="loading-circle"></div>
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group">Location <input autocomplete="off" name="exp[0][]" type="text"
                              id="emp_location0" placeholder="Location" class="form-control" />
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group">Employment type
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group"> Start date
                            <input name="exp[0][]" class="monthYearPicker form-control" id="emp_start0"
                              placeholder="Ex: Sep <?= date("Y") ?>" />
                          </div>

                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group"> End date
                            <input name="exp[0][]" class="monthYearPicker form-control" id="emp_end0"
                              placeholder="Ex: Sep <?= date("Y") ?>" />
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group"> Roles and Responsibilities
                            <input autocomplete="off" name="exp[0][]" type="text" placeholder="Description"
                              class="form-control" id="emp_resp0" />
                          </div>
                        </div>
            ...
            <div class="tab">
              <div class="container">
                <div class="row">
                  <div class="col-lg-1">&nbsp;</div>
                  <div class="col-lg-10 py-4">
                    <div class="h3 text-center fw-bold">Education</div>
                    <div class="list_wrapper" style="margin-top:30px;">
                      <div class="row education">
                        <div class="col-xs-3 col-sm-3 col-md-3">
                          <div class="form-group"> Degree *<select class="form-control py-3 select-box" id="degree0"
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                          <div class="form-group"> Major *<input autocomplete="off" name="list[0][]" type="text"
                              placeholder="Major" class="form-control" id="major0" />
                          </div>
                          <div class="req text-danger" id='major0_error'>This field is required</div>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2">
                          <div class="form-group"> University *<input autocomplete="off" name="list[0][]" type="text"
                              placeholder="University" class="form-control" id="university0" />
                          </div>
                          <div class="req text-danger" id='university0_error'>This field is required</div>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2">
                          <div class="form-group"> Start date *<input autocomplete="off" name="list[0][]"
                              placeholder="Start date" class="form-control datepicker" id="edu_start0" />
                          </div>
                          <div class="req text-danger" id='edu_start0_error'>This field is required</div>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2">
                          <div class="form-group"> End date *<input autocomplete="off" name="list[0][]"
                              placeholder="End date" class="form-control datepicker" id="edu_end0" />
                          </div>
                          <div class="req text-danger" id='edu_end0_error'>This field is required</div>
                        </div>
                        <div class="col-xs-1 col-sm-1 col-md-1">
                  ...
                  <div class="col-lg-10 py-4">
                    ...
                    <div class="cert_wrapper" style="margin-top:30px;">
                      <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group"> Name <input autocomplete="off" name="cert_details[0][]" type="text"
                              id="cert_name0" placeholder="Name" class="form-control" />
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                          <div class="form-group"> Issuer <input autocomplete="off" name="cert_details[0][]" type="text"
                              id="cert_issuer0" placeholder="Issuer" class="form-control" />
                          </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                          <div class="form-group allowinttype"> Year <input autocomplete="off" name="cert_details[0][]"
                              id="cert_year0" placeholder="Year" class="form-control datepicker"
                              onkeypress="return isNumber(event)" maxlength="4" minlength="4" />
                          </div>
                        </div>
                      ...
                      <div id="popup" class="popup">
                        ...
                        <div class="container my-4">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <span>Minimum *</span>
                              <input type="number" class="form-control" placeholder="minimum" name="pph_min" id="pph_min">
                              <div class="req text-dange " id="pph_min_error">This field is required</div>
                            </div>

                            <div class="col-lg-4 col-md-6">
                              <span>Maximum *</span>
                              <input type="number" class="form-control" placeholder="maximum" name="pph_max" id="pph_max">
                              <div class="req text-dange " id="pph_max_error">This field is required</div>
                            </div>
                          </div>
                          <div class="req text-dange " id="pph_error">This field is required</div>
                        ...
                        <label class='fw-bold' style="margin-top:30px; margin-bottom:0px!important;">Short bio *</label>
                        <textarea type="text" class="form-control py-3 mb-2" rows="3" placeholder='Short bio' name="bio"
                          id="bio"></textarea>
                        <div class="req text-danger" id="bio_error">This field is required</div>
                      </div>
                      <div class="col-lg-5">&nbsp;</div>
...
<script type="text/javascript">
  ...
  $('.list_add_button').click(function () {
    ...
    if (x < list_maxField) {
      ...
      var list_fieldHTML =
        '<div class="row education"> <div class="col-xs-3 col-sm-3 col-md-3"> <div class="form-group"> Degree *<select class="form-control py-3 select-box" id="degree' +
        x + '" name="list[' + x +
        '][]"> <option value="None">Select Degree</option><option value="School">School</option> <option value="Diploma">Diploma</option> <option value="Bachelors">Bachelors</option> <option value="Masters">Masters</option> <option value="PHD">Phd</option> </select> </div> <div class="req text-danger" id="degree' +
        x +
        '_error">This field is required</div> </div> <div class="col-xs-2 col-sm-2 col-md-2"> <div class="form-group"> Major *<input autocomplete="off" name="list[' +
        x + '][]" type="text" placeholder="Major" class="form-control" id="major' + x +
        '"/> </div> <div class="req text-danger" id="major' + x +
        '_error" >This field is required</div> </div> <div class="col-xs-2 col-sm-2 col-md-2"> <div class="form-group"> University *<input autocomplete="off" name="list[' +
        x + '][]" type="text" placeholder="University" class="form-control" id="university' + x +
        '"/> </div> <div class="req text-danger" id="university' + x +
        '_error" >This field is required</div> </div> <div class="col-xs-2 col-sm-2 col-md-2"> <div class="form-group"> Start date *<input autocomplete="off" name="list[' +
        x + '][]"  placeholder="Start date" class="form-control datepicker" id="edu_start' + x +
        '" /> </div> <div class="req text-danger" id="edu_start' + x +
        '_error" >This field is required</div> </div> <div class="col-xs-2 col-sm-2 col-md-2"> <div class="form-group"> End date *<input autocomplete="off" name="list[' +
        x + '][]" placeholder="End date" class="form-control datepicker" id="edu_end' + x +
        '" /> </div> <div class="req text-danger" id="edu_end' + x +
        '_error" >This field is required</div> </div> <div class="col-xs-1 col-sm-7 col-md-1"><a href="javascript:void(0);" class="list_remove_button btn btn-danger" id="' + x + '" style = "margin-top:20px;" id="'+ x +'"> -</a></div > </div > '; //New input field html
...
<?php if(isset($profile_skills)){ ?>
      let initialCount = 0 + <?php echo sizeof($profile_skills) - 1;?>
  <?php }else{ ?>
      let initialCount = 4; //Initial field counter
  <?php } ?>
  ...
  $('.add_skill').click(function () {
    if (initialCount < allowedCount) {
      ...
      var list_fieldHTML =
        '<div class="row skill_list"><div class="col-lg-5 mt-2"><div class="position-relative"><input type="text" class="form-control skillAutoComplete"  name="skill_details[' +
        initialCount +
        '][]" placeholder="Skill name" id="skill_name' + initialCount +
        '" /><div class="loading-circle"></div></div><div class="req text-danger" id="skill_name' + initialCount +
        '_error">This field is required</div></div> <div class="col-lg-2 mt-2"><input type="number" class="form-control" name="skill_details[' +
        initialCount +
        '][]" placeholder="Years" id="skill_year' + initialCount +
        '"/> <div class="req text-danger" id="skill_year' + initialCount +
        '_error">This field is required</div></div><div class="col-lg-2 mt-2"><input type="number" class="form-control" name="skill_details[' +
        initialCount +
        '][]" placeholder="Months" id="skill_month' + initialCount +
        '"/><div class="req text-danger" id="skill_month' + initialCount +
        '_error">This field is required</div></div><div class="col-lg-1"><a href="javascript:void(0);" class="skill_remove_button btn btn-danger mt-2" id="' + initialCount + '">-</a></div> </div>'; //New input field html
  ...
  var exp_count = 0; //Initial field counter
  ...
  $('.exp_add_button').click(function () {
    ...
    if (exp_count < list_maxField) {
      ...
      var list_fieldHTML =
        '<div class="row mt-10" style="margin-top:20px;"><div class="col-xs-4 col-sm-4 col-md-4"><div class="form-group">Compnay name <input autocomplete="off" name="exp[' +
        exp_count +
  ...
  let xy = 0; //Initial field counter
...
<script src="<?=base_url('assets/js/')?>upload-profile-draft-v2.js"></script>
<script>
  $(document).ready(function() {
      $('#country').select2();
  });
...
$.updateaction = function(data) {
        ...
        $("#regForm").attr("action",base_url + 'admin/vendor/editdraftformdata?step=tab&id='+ data);
    };
    
$.updateactionsubmit = function(data) {
        
        $("#regForm").attr("action",base_url + 'admin/vendor/editdraftformdata?step=submit&id='+ data);
    };
    
var currentTab = <?php echo $currentTab; ?>; // Current tab is set to be the tab where left previously

if (document.getElementsByClassName("tab").length - currentTab  === 1){ 
...
showTab(currentTab);
    ...
    if(n==-1){
        if(document.getElementsByClassName("tab").length-currentTab === 2){
            action_value = document.getElementById("regForm").action;
            $.updateaction(action_value.substring(action_value.lastIndexOf('=')+1));
        }  
    }
...
<script>
  ...
  function validateImage(callback) {
    ...
    function getUniqueId() {
      return new Promise(function(resolve, reject) {
        $.ajax({
          url: base_url + 'admin/vendor/findUniqueId',
          type: 'GET',
          dataType: 'json',
  ...
  function dataURLtoFile(dataURL, fileName) {
    ...
    save.addEventListener("click", function (e) {
        ...
        getUniqueId()
          .then(function(uniqueId) {
            var fileTitle = last_name.value + ' ' + uniqueId +  ' Talrn.webp';
            formData.append("fileTitle", fileTitle);
            // 0 means new user
            formData.append("userType", 0)
            formData.append("newUserId", user_id)
    ...
    deleteProfileImg.addEventListener("click", function (e) {
        ...
        let fileName = imageFileName.value.split("uploads/")[1];
        
        if (cropped.src.includes("_Talrn") !== false) {
            var matches = cropped.src.match(/uploads\/(.*)/);
        ...
        formData.append("uniqueId", user_id)
