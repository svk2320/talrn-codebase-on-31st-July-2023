...
<div class="content-wrapper">
  ...
  <style>
    ...
    <nav class="navbar navbar-expand-lg classic transparent navbar-light">
		...
		<div class="container flex-lg-row flex-nowrap align-items-center">
			<div class="navbar-brand w-25 my-md-3">
					<img src="<?= base_url('assets/img/newlogo.png') ?>"
						srcset="<?= base_url('assets/img/newlogo.png') ?>" style="width:27%" alt="" />
    ...
    <b>You are submitting your profile for final review, please check the information here and scroll down to submit profile for approval.</b>
    </div>
  ...
  <div class="container">
    <section class="px-3 border-bottom">
      <section>
        <div class="row mt-4">
            <!--<div class="my-4" style="border:4px solid grey;"><h4 class="my-4 text-center text-dark">You are submitting your profile for final review, please check the information here and scroll down to submit profile for approval.</h4></div>-->
            ...
            <div class="mt-3">
              <div class="h5 text-muted" id="profile-title">
                <?php echo $fullname; ?><span class="uid">
                  ...
                  <?php echo $profiles[0]['active'] === '1' ? '<span class="text-green" style="font-size: 12px;">Active</span>' : '<span class="text-red" style="font-size: 12px;">Draft</span>'; ?>
                </span>
              </div>
...
?>
 ...
 if (!($work_location == "N;" || $work_location == "")) {
    ...
    <?php if($_SESSION['registered_as'] == 2){ ?>
    <section class="px-3 border-bottom">
        <div class="row py-3 mt-1">
            <div class="col-lg-4">
                <div class="h5">
              ...
              <div class="subsection-2 py-4 mb-1">
                ...
                <div class="row col-md-6">
                  <div class="col-md-6 text-md-end">
                    <a href="<?= base_url("admin/vendor/changestatusToInactive/") . $profiles[0]['id'] ?>"
                  ...
                  <div class="col-md-6">
                    <a href="<?= base_url("admin/vendor/") ?>"
                      class="btn btn-primary  rounded-pill mb-2 mb-md-0">
                      Edit profile  
                    </a>
                  </div>
                </div>
...
<footer class="bg-dark text-light">
  <div class="container">
    ...
    <div class="row py-5">
      <div class="col-lg-12" id="footer-one">
        &copy;
        <?php echo date('Y'); ?> Talrn <a href="https://blog.talrn.com" target="_blank" rel="noopener noreferrer">(1st Feb
            Release Notes)</a> ⚡ by <a href="https://superlabs.co" target="_blank" rel="noopener noreferrer">SuperLabs.</a>
        <div class="d-sm-inline-block" style="margin-left:10px;">
            Our goal is to match you with the best work faster & simplified. <a href="mailto:adam@talrn.com" target="_blank"
  ...
  <script src="<?php echo base_url() . $this->config->item('js') . 'fas-fonts.js' ?>" ></script>
