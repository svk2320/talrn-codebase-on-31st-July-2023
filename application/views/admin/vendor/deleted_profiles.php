    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6" style="display:flex">
          <h1 class="m-0 text-dark">Deleted Profiles</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('admin') ?>">Home</a></li>
            <li class="breadcrumb-item active">Deleted Profiles</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
        ...
        <table id="userTable" class="table table-hover text-nowrap" >
          <thead>
            <tr>
              ...
              <th data-priority="14">Company</th>
...
<script type="text/javascript">
  ...
  $("#deletedProfileList").addClass('active');

  $('#userTable').DataTable({
    order: [],
    responsive: true,
    autoWidth: false,
    ajax: '<?=base_url()?>' + 'admin/DeletedProfiles/fetchDeletedProfiles',
    dom: '<"pull-left"f><"pull-right"l>tip',
    language: {
      "zeroRecords": "No profiles deleted!" 
    }
  });

  history.pushState({}, null, '<?= base_url('admin/vendor/deleted_profiles') ?>');
});
