...
<div class="content-wrapper">
  ...
  <style>
	...
	<nav class="navbar navbar-expand-lg classic transparent navbar-light">
		...
		<div class="container flex-lg-row flex-nowrap align-items-center" style="padding-top: 15px; padding-bottom: 15px;">
    ...
    <section class="px-3 border-bottom">
      <section>
        <div class="row mt-4">
         ...
         <div class="row">
            <div class="text-muted col-lg-6 col-md-6">
                <i class="uil uil-arrow-left"></i> <a href="<?= base_url('admin'); ?>">Home</a> /
                <?php echo $profiles[0]['unique_id']; ?>
            </div>
          
            <div class="toggle-bar col-lg-6 col-md-6">
                <span id="toggleText">Private View</span>&nbsp;->&nbsp;<a id="toggleText2" style="color: #5271ff; cursor: pointer;" class="toggle-button text-decoration-underline" onclick="toggleText()"><u>Switch to public</u></a>
            </div>
         </div>
...
?>
  ...
  <div id="hiddenText" style="display: block;">
    <section class="px-3 border-bottom">
            <div class="row py-3 mt-1">
                <div class="col-lg-4">
                    <div class="h5">
  ...
  <!-- page footer -->
    <footer class="bg-dark text-light py-6" style="padding-top: 0.5rem !important; margin-top: 5%;">
  <div class="container">

    <div class="row pt-5">
      <div class="col-lg-6" id="footer-one">
        <span>
          <script type="text/javascript">
            document.write("&copy 2022 - " + new Date().getFullYear());
          </script>
        </span>
        <span style="color:white; font-size:20px; padding-left:10px; padding-right:10px;">Talrn</span>-<span
          class="px-2">Labor Omnia Vincit</span>⚡ by &nbsp;<a href="https://superlabs.co" target="_blank">SuperLabs</a>
      </div>
      <div class="col-lg-6" id="footer-second">
        <span class="px-3 second-items"><a style="color:lightgray" href="<?= base_url('terms-and-conditions') ?>">Terms of
            Use</a></span>
        <span class="px-3 second-items"><a style="color:lightgray" href="<?= base_url('privacy-policy') ?>">Privacy
            Policy</a></span>
      </div>
    </div>
  </div>
...
<script>
    function toggleText() {
        ...
        var toggleText2Element = document.getElementById("toggleText2");
        
        if (hiddenText.style.display === "none") {
            hiddenText.style.display = "block";
            toggleTextElement.textContent = "Private View";
            toggleText2Element.textContent = "Switch to public";
        } else {
            hiddenText.style.display = "none";
            toggleTextElement.textContent = "Public View";
            toggleText2Element.textContent = "Switch to private";
        }
    }
</script>
