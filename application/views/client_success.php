        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                ...
                <div class="jumbotron text-center">
                    <h1 class="text-primary">Redirecting You!</h1>
                    <p class="lead">Please check your email <strong><?php echo $email; ?></strong> for your login information and account activation.</p>
                    <p class="lead">We will be redirecting you to your dashboard in </p>
                    <h1><span id="seconds">5</span>s</h1>
                    <br>
                    <p class="lead">
                        <a class="btn btn-primary btn-sm" onclick="redirect()" role="button" onclick="">Continue to dashboard</a>
                    </p>
                </div>
